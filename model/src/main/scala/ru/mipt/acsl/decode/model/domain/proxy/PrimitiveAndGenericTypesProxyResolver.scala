...
import ru.mipt.acsl.decode.model.domain.impl.types.{GenericType, GenericTypeSpecialized}
import ru.mipt.acsl.decode.model.domain.proxy.path.{GenericTypeName, ProxyPath}
