...
class MavlinkSourceGeneratorConfigCliParser
  extends scopt.OptionParser[MavlinkSourceGeneratorCliConfig]("mavlink2decode") {
  ...
  def parse(args: Array[String]): Option[MavlinkSourceGeneratorCliConfig] =
    parse(args, MavlinkSourceGeneratorCliConfig())
